...
CREATE TABLE IF NOT EXISTS libros(
	...
	coleccion_id int,
	CONSTRAINT fk_coleccion FOREIGN KEY (coleccion_id) REFERENCES colecciones(id) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS poblaciones(
	...
	nombre varchar(100),
	provincia_id int,
	CONSTRAINT fk_provincia_id FOREIGN KEY (provincia_id) REFERENCES provincia(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS socios(
	...
	poblacion_id int,
	CONSTRAINT fk_socio_id FOREIGN KEY (socio_avalador_id) REFERENCES socios(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS detalles_pedidos(
	...
	CONSTRAINT fk_isbn FOREIGN KEY (isbn) REFERENCES libros(isbn) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT pk_detalles_pedido PRIMARY KEY (consecutivo, pedido_id)
